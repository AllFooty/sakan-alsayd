      ...
      <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="flex items-start justify-between px-5 py-4 border-b border-gray-100">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 h-10 w-10 rounded-full bg-amber-50 text-amber-600 flex items-center justify-center">
              <LogOut size={18} />
            </div>
            <div>
              ...
              {subtitleLine && (
                <p className="text-xs text-gray-400 mt-0.5">{subtitleLine}</p>
              )}
            </div>
          </div>
          <button
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-gray-50 text-sm">
            ...
            <span className="text-gray-500">{t('checkOut.info.checkInLabel')}:</span>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="block w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-navy shadow-sm focus:border-coral focus:outline-none focus:ring-1 focus:ring-coral resize-none"
            />
            <p className="mt-1 text-xs text-gray-400 text-end tabular-nums">
